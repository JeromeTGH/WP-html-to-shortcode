        ...
        if($new_title != "" && $new_content != "") {
            if(ctype_alnum($check_title)) {
                ...
                if($doublon == 0) {
                    ...
                    ?>
                    <div style="color: red;">This HTML Title already exists, sorry...</div>
                    <?php	
                }
            } else {
                ?>
                <div style="color: red;">HTML Title can have only alphanumerics characters, sorry...</div>
                <?php
            }
        } else {
            ?>		
            <div style="color: red;">Fill all mandatory fields, please !</div>
            <?php 
        }
    }
?>
...
<div>
	<fieldset style="width: 99%; border: 1px solid #F7F7F7; padding: 10px 0px;">
		<form name="formAddWPHTSblock" id="formAddWPHTSblock" method="post">
			<?php
